...
def get_parser():
    ...
    parser.add_argument("--logging_gen_steps", type=int, default=100, help="Log Generated Image every X updates steps.")
    ...
    parser.add_argument('--optimizer_state_path', type=str, default=None,
                        help='The path of optimizer state to load')
    ...
    parser.add_argument('--finetune_mmonlyimage', action='store_true', default=False,
                        help = "help agumentation sequence control")
    parser.add_argument('--finetune_styleonly', action='store_true', default=False,
                        help = "help agumentation sequence control")
    parser.add_argument('--initial_image_path', type=str, default=None,
                        help='The path of initial image for inference')
    parser.add_argument('--condition_path', type=str, default=None,
                        help='The path of condition image for inference')
