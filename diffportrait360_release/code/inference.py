...
def main(args):
    ...
    for itr in range(0, len(test_image_dataloader)):
        ...
        if os.path.isdir((f"{args.local_image_dir}/{test_batch_data['image_name'][0].split('.')[0]}")) or os.path.isfile((f"{args.local_image_dir}/{test_batch_data['image_name'][0]}")):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_video', action='store_true', default=False, help='Save results as video')
